...
const printarCarrito=()=> {
    const items= document.getElementById ("items");
    items.innerHTML="";
    cart.forEach(item => {
        templateCarrito.querySelector("th").textContent=item.id
        templateCarrito.querySelector("td").textContent=item.name
        templateCarrito.querySelector("td").textContent=item.price
        templateCarrito.querySelector("td").textContent=item.quantity
